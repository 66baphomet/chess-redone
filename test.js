...
)
{
    ...
    function checkKingCheck(firstSquare, secondSquare){
        for(let i =0; i<=63; i++)
        {
            if(allSquares[i].classList.contains("blackKing") && allSquares[i].classList.contains("checkedByWhite"))
            {
                allSquares[i].classList.add("kingUnderCheck");
            }

            if(allSquares[i].classList.contains("whiteKing") && allSquares[i].classList.contains("checkedByBlack"))
            {
                allSquares[i].classList.add("kingUnderCheck");
            }
        }
